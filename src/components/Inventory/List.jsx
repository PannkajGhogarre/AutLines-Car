...
const cars1 = [
  {
    ...
    transmission: 'Manual',
    years: '2019',
    year: <i class="ri-calendar-2-line">YEAR:</i>,
    mil: <i class="ri-speed-up-fill">MILEAGE:</i>,
    fu: <i class="ri-water-percent-line">FUEL:</i>,
    trans: <i class="ri-list-settings-line">TRANSMISSION:</i>,
  },
  {
    name: 'Ford Focus ST',
    desc: 'Stock#: 45098ES – 4 door, White, 2.5L, FWD,Automatic 6-Speed, 2.5L 5 cyls, Florida CA',
            ...
            <div className="py-10 px-5">
              {cars1.map((car, index) => (
                <motion.div key={index}
                  ...
                  <img src={car.image} alt={car.name} className="w-72 h-44 object-cover mt-5 rounded-md mx-auto" />
